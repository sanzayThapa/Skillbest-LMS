...
async function PATCH(req) {
    try {
        ...
        const { name, phone, bio, headline, gender, dateOfBirth, website, twitter, facebook, linkedin, youtube } = body;
        if (!session?.user?.email) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]("Unauthorized", {
                status: 401
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__83a3de67._.js.map