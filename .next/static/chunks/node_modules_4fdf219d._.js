...
function De(e, t) {
    ...
    t.on(g.Events.MANIFEST_PARSED, function(l, u) {
        ...
        for (let [d, p] of u.levels.entries()){
            ...
            r.set(p, "".concat(d)), T.id = "".concat(d);
        }
        ...
        for (let c of u.audioTracks){
            ...
            p.id = "".concat(c.id), c.default && (p.enabled = !0);
        }
...
function Ce(e, t) {
    t.on(g.Events.NON_NATIVE_TEXT_TRACKS_FOUND, (o, param)=>{
        ...
        s.forEach((a)=>{
            var c, d;
            let i = (c = a.subtitleTrack) != null ? c : a.closedCaptions, l = t.subtitleTracks.findIndex((param)=>{
                let { lang: p, name: T, type: m } = param;
                return p == (i == null ? void 0 : i.lang) && T === a.label && m.toLowerCase() === a.kind;
            }), u = ((d = a._id) != null ? d : a.default) ? "default" : "".concat(a.kind).concat(l);
    ...
    let r = ()=>{
        ...
        if (t.subtitleTrack < 0 || (o == null ? void 0 : o.id) !== a) {
            let i = t.subtitleTracks.findIndex((param)=>{
                let { lang: l, name: u, type: c, default: d } = param;
                return o.id === "default" && d || l == o.language && u === o.label && c.toLowerCase() === o.kind;
            });
            t.subtitleTrack = i;
        }
...
function ke(e) {
    ...
    let { currentTime: n } = e, o = Array.prototype.find.call((a = r.activeCues) != null ? a : [], (param)=>{
        let { startTime: i, endTime: l } = param;
        return i <= n && l > n;
    });
...
var Dt = (e)=>{
    ...
    let { playbackId: e, customDomain: t = A, maxResolution: r, minResolution: n, renditionOrder: o, programStartTime: s, programEndTime: a, assetStartTime: i, assetEndTime: l, playbackToken: u, tokens: { playback: c = u } = {}, extraSourceParams: d = {} } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    if (!e) return;
    let [p, T = ""] = F(e), m = new URL("https://stream.".concat(t, "/").concat(p, ".m3u8").concat(T));
    return c || m.searchParams.has("token") ? (m.searchParams.forEach((R, M)=>{
        M != "token" && m.searchParams.delete(M);
    }), c && m.searchParams.set("token", c)) : (r && m.searchParams.set("max_resolution", r), n && (m.searchParams.set("min_resolution", n), r && +r.slice(0, -1) < +n.slice(0, -1) && console.error("minResolution must be <= maxResolution", "minResolution", n, "maxResolution", r)), o && m.searchParams.set("rendition_order", o), s && m.searchParams.set("program_start_time", "".concat(s)), a && m.searchParams.set("program_end_time", "".concat(a)), i && m.searchParams.set("asset_start_time", "".concat(i)), l && m.searchParams.set("asset_end_time", "".concat(l)), Object.entries(d).forEach((param)=>{
        let [R, M] = param;
    ...
    v(t, "encrypted", async (n)=>{
        try {
            ...
            let i = await Promise.all([
                ...
                let [, u] = param;
                return u;
            }), l = await Bt(i, G(e, "fairplay")).catch((u)=>{
    ...
    if (v(t, "durationchange", u), t && n) {
        ...
        if (typeof o == "string") {
            if (o.endsWith(".mp4") && o.includes(s)) {
                let R = qe(o), M = new URL("https://stream.".concat(s, "/").concat(R, "/metadata.json"));
                de(M.toString(), t);
            }
            let T = ()=>{
...
//# sourceMappingURL=node_modules_4fdf219d._.js.map