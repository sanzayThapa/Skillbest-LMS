...
"[project]/node_modules/jquery/dist-module/jquery.module.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function jQueryFactory(window1, noGlobal) {
 ...
 */ function select(selector, context, results, seed) {
    ...
    rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init = jQuery.fn.init = function(selector, context) {
        ...
        // Shortcut for document ready
            ...
            return rootjQuery.ready !== undefined ? rootjQuery.ready(selector) : // Execute immediately if ready is not present
            selector(jQuery);
        } else {
 ...
 */ jQuery.Callbacks = function(options) {
    ...
    jQuery.Deferred.exceptionHook = function(error, asyncError) {
        if (error && rerrorNames.test(error.name)) {
            window1.console.warn("jQuery.Deferred exception", error, asyncError);
        }
    };
 ...
 */ jQuery.event = {
    ...
    function getWidthOrHeight(elem, dimension, extra) {
        ...
        val === "auto" || isIE && isBorderBox || !support.reliableColDimensions() && nodeName(elem, "col") || !support.reliableTrDimensions() && nodeName(elem, "tr")) && // Make sure the element is visible & connected
    ...
    function schedule() {
        if (inProgress) {
            if (document$1.hidden === false && window1.requestAnimationFrame) {
                window1.requestAnimationFrame(schedule);
            } else {
                window1.setTimeout(schedule, 13);
            }
            jQuery.fx.tick();
        }
    }
 ...
 */ function ajaxConvert(s, response, jqXHR, isSuccess) {
    ...
    jQuery.ajaxPrefilter(function(s, origOptions) {
        ...
        if (s.data instanceof window1.FormData) {
            s.contentType = false;
        }
    });
...
;
const __TURBOPACK__default__export__ = jQuery;
}),
"[project]/node_modules/jquery/dist/wrappers/jquery.bundler-require-wrapper.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

// Bundlers are able to synchronously require an ESM module from a CommonJS one.
const { jQuery } = __turbopack_context__.r("[project]/node_modules/jquery/dist-module/jquery.module.js [app-client] (ecmascript)");
module.exports = jQuery;
}),
]);

//# sourceMappingURL=node_modules_jquery_90cf5b7a._.js.map