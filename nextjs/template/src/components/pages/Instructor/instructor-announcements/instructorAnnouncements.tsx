  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: string,record:any) => (
        <div>
          <h6 className="mb-1"><Link href="#" data-bs-toggle="modal" data-bs-target="#view_announcement">{text}</Link></h6>
    ...
    },
    {
      ...
      render: () => (
        <div className="d-flex align-items-center">
          <Link href="#" className="d-inline-flex fs-14 me-1 action-icon"><i className="isax isax-edit-2" data-bs-toggle="modal" data-bs-target="#edit_announcement"></i></Link>
...
export default InstructorAnnouncementsComponent
