					...
					<div className="row">
						...
						<div className="col-lg-9">
							<div className="page-title d-flex align-items-center justify-content-between">
								...
								<div>
									<Link href="#" className="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#add_quiz">Add Quiz</Link>
								</div>
							</div>
							<div className="border rounded-2 p-3 mb-3">
								<div className="row align-items-center">
									<div className="col-md-8">
										<div>
											<h6 className="mb-2"><Link href={all_routes.instructorQA}>Information About UI/UX Design Degree</Link></h6>
									...
									<div className="col-md-4">
										<div className="d-flex align-items-center justify-content-end mt-2 mt-md-0">
											...
											<Link href="#" className="d-inline-flex fs-14 me-1 action-icon" data-bs-toggle="modal" data-bs-target="#edit_quiz"><i className="isax isax-edit-2"></i></Link>
							...
							<div className="border rounded-2 p-3 mb-3">
								<div className="row align-items-center gy-3">
									<div className="col-md-8">
										<div>
											<h6 className="mb-2"><Link href={all_routes.instructorQA}>Learn JavaScript and Express to become a Expert</Link></h6>
											<div className="question-info d-flex align-items-center">
							...
							<div className="border rounded-2 p-3 mb-3">
								<div className="row align-items-center gy-3">
									<div className="col-md-8">
										<div>
											<h6 className="mb-2"><Link href={all_routes.instructorQA}>Introduction to Python Programming</Link></h6>
											<div className="question-info d-flex align-items-center">
							...
							<div className="border rounded-2 p-3 mb-3">
								<div className="row align-items-center gy-3">
									<div className="col-md-8">
										<div>
											<h6 className="mb-2"><Link href={all_routes.instructorQA}>Build Responsive Websites with HTML5 and CSS3</Link></h6>
											<div className="question-info d-flex align-items-center">
									...
									<div className="col-md-4">
										<div className="d-flex align-items-center justify-content-end mt-2 mt-md-0">
											<Link href={all_routes.instructorQuizResult} className="text-info text-decoration-underline fs-12 fw-medium me-3">View Results</Link>
											<Link href="#" className="d-inline-flex fs-14 me-1 action-icon"><i className="isax isax-edit-2"></i></Link>
											<Link href="#" className="d-inline-flex fs-14 action-icon"><i className="isax isax-trash"></i></Link>
										</div>
									</div>
								</div>
							</div>
							<div className="border rounded-2 p-3 mb-3 mb-0">
								<div className="row align-items-center gy-3">
									<div className="col-md-8">
										<div>
											<h6 className="mb-2"><Link href={all_routes.instructorQA}>Information About Photoshop Design Degree</Link></h6>
											<div className="question-info d-flex align-items-center">
...
export default InstructorQuizComponent
